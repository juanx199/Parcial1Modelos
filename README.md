...
- Bdidge - Separación de formato de contenido
...
- Decoratos - Adición dinámica de secciones
...
- - Identifica el estado inrínseco compartible de los estilos de texto (tipo de letra, tamaño, color):
